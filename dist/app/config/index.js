...
exports.appConfig = {
    database: {
        ...
        dataBase_uri: process.env.MONGO_URI, // Optional: if you're using full URI instead
    },
    server: {
    ...
    payment: {
        ...
        payu: {
            ...
            accountId: parseInt(process.env.PAYU_ACCOUNT_ID, 10),
            merchantId: parseInt(process.env.PAYU_MERCHANT_ID, 10),
