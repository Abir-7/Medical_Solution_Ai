...
const jobs_1 = require("../../rabbitMq/jobs");
...
const createUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        //   `Your code is: ${otp}`
        // );
        yield userToken_model_1.default.create([{ token: 20, user: createdUser[0]._id }], {
            session,
        });
        yield (0, jobs_1.dispatchJob)({
            type: "email",
            data: {
                to: data.email,
...
const verifyUser = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const expirationDate = (_a = user === null || user === void 0 ? void 0 : user.authentication) === null || _a === void 0 ? void 0 : _a.expDate;
    if (otp !== ((_b = user === null || user === void 0 ? void 0 : user.authentication) === null || _b === void 0 ? void 0 : _b.otp)) {
...
const getNewAccessToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userEmail && userId && userRole) {
        ...
        const accessToken = jwt_1.jsonWebToken.generateToken(jwtPayload, config_1.appConfig.jwt.jwt_access_secret, config_1.appConfig.jwt.jwt_access_exprire);
        const data = (0, jwt_decode_1.jwtDecode)(accessToken);
        console.log(data.exp);
        return {
            accessToken,
            access_token_valid_till: data === null || data === void 0 ? void 0 : data.exp,
        };
    }
    else {
